            ...
            courses: [
                {
                    ...
                    title: ' Data Competitive Strategy law & Organizatio ',
                ...
                },
                {
                    ...
                    duration :  '6.5',
                    lessons :  '97 ',
                    img :  'assets/images/course/img_02.jpeg',
                    authorImg :  'assets/images/course/course-2.jpg',
                ...
                },
                {
                    ...
                    duration :  '6.5',
                    lessons :  '97 ',
                    img :  'assets/images/course/img_03.webp',
                    authorImg :  'assets/images/course/course-2.jpg',
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-xl-8">
                        <div className="section-heading mb-70 text-center">
                            <h2 className="font-lg">Classes</h2>
                            <p>Discover Your Perfect Program In Our Classes.</p>
                        </div>
                    </div>
                </div>
...

                {
                    this.state.courses.map((data,i)=> (
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6" key={data.id}>
