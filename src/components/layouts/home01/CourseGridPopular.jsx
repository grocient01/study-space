            ...
            coursePopular: [
                {
                    ...
                    duration :  '6.5',
                    lessons :  '97 ',
                    img :  'assets/images/student/st-1.png',
                    title: 'All India AIR-1',
                },
                {
                    id: 2,
                    review: '4.5 ',
                    ...
                    duration :  '6.5',
                    lessons :  '97 ',
                    img :  'assets/images/student/st-2.jpg',
                    title: 'Best foundation course award',
                ...
                },
                {
                    ...
                    duration :  '6.5',
                    lessons :  '97 ',
                    img :  'assets/images/student/st-3.jpg',
                ...
                },
                {
                    ...
                    duration :  '6.5',
                    lessons :  '97 ',
                    img :  'assets/images/student/st-4.jpeg',
                    title: ' Best hight tech classes',
                ...
                <div className="row justify-content-center">
                    <div className="col-xl-8">
                        <div className="section-heading mb-70 text-center">
                            <h2 className="font-lg">Success</h2>
